...
class FilmAdvanture(QWidget):
   #Membuat fungsi init untuk inisialisasi class Mahasiswa
    ...
    def LayoutAdvanture(self, Mwindow1):
        ...
        btn_cari.clicked.connect(self.filterDataAdvanture)
        btn.clicked.connect(self.tampilDataAdvanture)
        ...
        Mwindow1.setWindowTitle("List of Advanture")
