...
class FilmDrama(QWidget):
   #Membuat fungsi init untuk inisialisasi class Mahasiswa
    ...
    def LayoutDrama(self, Mwindow1):
        ...
        btn_cari.clicked.connect(self.filterDataDrama)
        btn.clicked.connect(self.tampilDataDrama)
        ...
        Mwindow1.setWindowTitle("List of Drama")
