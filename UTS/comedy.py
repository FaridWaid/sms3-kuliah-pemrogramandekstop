...
class FilmComedy(QWidget):
   #Membuat fungsi init untuk inisialisasi class Mahasiswa
    ...
    def LayoutComedy(self, Mwindow1):
        ...
        btn_cari.clicked.connect(self.filterDataComedy)
        btn.clicked.connect(self.tampilDataComedy)
        ...
        Mwindow1.setWindowTitle("List of Comedy")
